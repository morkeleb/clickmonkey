...
function modeLockHint(mode: WalkerModeName): string {
  ...
  if (mode === "form") {
    return "Prefer shown fields and in-page controls (buttons or links styled as buttons) over [nav] landmarks and sidebar. Fill empties then Save. Do not click leftover option_* from a previous combobox. A header New/Add link is a page action, not chrome.";
  }
  if (mode === "list") {
